sap.ui.define([
	...
	return Opa5.extend("cg.tr.com.cgui.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["cg/tr/com/cgui/localService/mockserver"], function (mockserver) {
